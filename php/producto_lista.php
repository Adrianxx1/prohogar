			   ...
			   $tabla.='</p>
			        ...
			        <div class="media-content">
			            ...
			            <div class="has-text-right">
			                <a href="inventario.php?vista=product_img&product_id_up='.$rows['producto_id'].'" class="button is-link is-rounded is-small">Imagen</a>
			                <a href="inventario.php?vista=product_update&product_id_up='.$rows['producto_id'].'" class="button is-success is-rounded is-small">Actualizar</a>
